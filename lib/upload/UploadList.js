  ...
  function UploadList() {
    ...
    _this.renderUploadList = function (_ref) {
      ...
      var list = items.map(function (file) {
        ...
        var progress;
        var icon = file.status === 'uploading' ? React.createElement(_icons.LoadingOutlined, null) : React.createElement(_icons.PaperClipOutlined, null);
        ...
        if (listType === 'picture' || listType === 'picture-card') {
          if (listType === 'picture-card' && file.status === 'uploading') {
            ...
            icon = React.createElement(_icons.PictureTwoTone, {
            ...
            }) : React.createElement(_icons.FileTwoTone, {
        ...
        var removeIcon = showRemoveIcon ? React.createElement(_icons.DeleteOutlined, {
          title: locale.removeFile,
          onClick: function onClick() {
            return _this.handleClose(file);
          }
        }) : null;
        var downloadIcon = showDownloadIcon && file.status === 'done' ? React.createElement(_icons.DownloadOutlined, {
      ...
      var listClassNames = (0, _classnames["default"])((_classNames4 = {}, _defineProperty(_classNames4, "".concat(prefixCls, "-list"), true), _defineProperty(_classNames4, "".concat(prefixCls, "-list-").concat(listType), true), _defineProperty(_classNames4, "".concat(prefixCls, "-list-rtl"), direction === 'rtl'), _classNames4));
