...
function Table(props) {
  ...
  var mergedExpandable = _extends({}, expandable); // Customize expandable icon


  mergedExpandable.expandIcon = mergedExpandable.expandIcon || expandIcon || (0, _ExpandIcon["default"])(tableLocale); // Adjust expand icon index
  ...
  return React.createElement("div", {
    ...
    prefixCls: prefixCls,
    className: (0, _classnames["default"])(className, (_classNames3 = {}, _defineProperty(_classNames3, "".concat(prefixCls, "-middle"), size === 'middle'), _defineProperty(_classNames3, "".concat(prefixCls, "-small"), size === 'small'), _defineProperty(_classNames3, "".concat(prefixCls, "-bordered"), bordered), _defineProperty(_classNames3, "".concat(prefixCls, "-rtl"), direction === 'rtl'), _classNames3)),
    data: pageData,
    rowKey: getRowKey,
    rowClassName: internalRowClassName,
    emptyText: renderEmpty('Table') // Internal
    ,
...
Table.Column = _rcTable.Column;
Table.ColumnGroup = _rcTable.ColumnGroup;
var _default = Table;
