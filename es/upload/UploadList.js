  ...
  function UploadList() {
    ...
    _this.renderUploadList = function (_ref) {
      ...
      var list = items.map(function (file) {
        ...
        var progress;
        var icon = file.status === 'uploading' ? React.createElement(LoadingOutlined, null) : React.createElement(PaperClipOutlined, null);
        ...
        if (listType === 'picture' || listType === 'picture-card') {
          if (listType === 'picture-card' && file.status === 'uploading') {
            ...
            icon = React.createElement(PictureTwoTone, {
        ...
        var removeIcon = showRemoveIcon ? React.createElement(DeleteOutlined, {
          title: locale.removeFile,
          onClick: function onClick() {
            return _this.handleClose(file);
          }
        }) : null;
        var downloadIcon = showDownloadIcon && file.status === 'done' ? React.createElement(DownloadOutlined, {
      ...
      var listClassNames = classNames((_classNames4 = {}, _defineProperty(_classNames4, "".concat(prefixCls, "-list"), true), _defineProperty(_classNames4, "".concat(prefixCls, "-list-").concat(listType), true), _defineProperty(_classNames4, "".concat(prefixCls, "-list-rtl"), direction === 'rtl'), _classNames4));
