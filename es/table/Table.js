...
function Table(props) {
  ...
  mergedExpandable.expandIcon = mergedExpandable.expandIcon || expandIcon || renderExpandIcon(tableLocale); // Adjust expand icon index
  ...
  return React.createElement("div", {
    ...
    prefixCls: prefixCls,
    className: classNames(className, (_classNames3 = {}, _defineProperty(_classNames3, "".concat(prefixCls, "-middle"), size === 'middle'), _defineProperty(_classNames3, "".concat(prefixCls, "-small"), size === 'small'), _defineProperty(_classNames3, "".concat(prefixCls, "-bordered"), bordered), _defineProperty(_classNames3, "".concat(prefixCls, "-rtl"), direction === 'rtl'), _classNames3)),
    data: pageData,
    rowKey: getRowKey,
