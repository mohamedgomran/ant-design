...
import getIcons from './utils/iconUtil'; // We still use class here since `forwardRef` not support generic in typescript
...
function (_React$Component) {
  ...
  function Select() {
    ...
    _this.renderSelect = function (_ref) {
      ...
      var selectProps = omit(_this.props, ['prefixCls', 'suffixIcon', 'itemIcon', 'removeIcon', 'clearIcon', 'size']);
      var mergedClassName = classNames(className, (_classNames = {}, _defineProperty(_classNames, "".concat(prefixCls, "-lg"), size === 'large'), _defineProperty(_classNames, "".concat(prefixCls, "-sm"), size === 'small'), _defineProperty(_classNames, "".concat(prefixCls, "-rtl"), direction === 'rtl'), _classNames));
