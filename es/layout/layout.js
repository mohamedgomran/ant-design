...
function (_React$Component2) {
  ...
  function BasicLayout() {
    ...
    _this2.renderComponent = function (_ref3) {
      ...
      var classString = classNames(className, prefixCls, (_classNames = {}, _defineProperty(_classNames, "".concat(prefixCls, "-has-sider"), typeof hasSider === 'boolean' ? hasSider : _this2.state.siders.length > 0), _defineProperty(_classNames, "".concat(prefixCls, "-rtl"), direction === 'rtl'), _classNames));
