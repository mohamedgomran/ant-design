...
function (_React$Component) {
  ...
  function RadioGroup(props) {
    ...
    _this.renderGroup = function (_ref) {
      ...
      var classString = classNames(groupPrefixCls, "".concat(groupPrefixCls, "-").concat(buttonStyle), (_classNames = {}, _defineProperty(_classNames, "".concat(groupPrefixCls, "-").concat(props.size), props.size), _defineProperty(_classNames, "".concat(groupPrefixCls, "-rtl"), direction === 'rtl'), _classNames), className);
